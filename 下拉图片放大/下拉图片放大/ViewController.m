...
- (void)viewDidLoad {
    ...
    self.zoomImageView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"123.jpg"]];
     self.zoomImageView.frame=CGRectMake(0, -ImageHight -64, self.view.frame.size.width, ImageHight + 64);
...
//    
    ...
    self.circleView = [[UIImageView alloc]initWithFrame:CGRectMake(10, ImageHight-30, 40, 40)];
